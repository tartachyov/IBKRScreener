...
Incoming.prototype._HISTORICAL_TICKS = function () {
    var reqId = this.dequeueInt();
    var tickCount = this.dequeueInt();
    var date;
    var price;
...
Incoming.prototype._TICK_BY_TICK = function () {
    ...
    switch (tickType) {
        ...
        case 2: // Alllast
            ...
            this._emit('tickByTickAllLast', reqId, tickType, time, price, size, { pastLimit: pastLimit, unreported: unreported }, exchange, specialConditions);
            break;
        case 3: // BidAsk
            ...
            this._emit('tickByTickBidAsk', reqId, time, bidPrice, askPrice, bidSize, askSize, { bidPastLow: bidPastLow, askPastHigh: askPastHigh });
            break;
        case 4: // MidPoint
...
Incoming.prototype._OPEN_ORDER = function () {
    ...
    if (version >= 11) {
        ...
        if (version === 11) {
            ...
            if (version >= 27 && !lodash_1.default.isEmpty(order.deltaNeutralOrderType)) {
            ...
            if (version >= 31 && !lodash_1.default.isEmpty(order.deltaNeutralOrderType)) {
...
Incoming.prototype._TICK_OPTION_COMPUTATION = function () {
    ...
    if (version >= 6 || tickType === constants_1.default.TICK_TYPE.MODEL_OPTION) { // introduced in version == 5
...
Incoming.prototype.dequeue = function () {
    if (this._dataQueue.length === 0) {
        throw new errors_1.default.UnderrunError();
    }
...
Incoming.prototype.process = function () {
    ...
    while (true) {
        ...
        try {
            ...
            if (constKey && lodash_1.default.has(this.constructor.prototype, '_' + constKey) && lodash_1.default.isFunction(this['_' + constKey])) {
                this['_' + constKey]();
            }
            else {
            ...
            if (!(e instanceof errors_1.default.UnderrunError)) {
                throw e;
            }
        ...
        this._emitQueue = [];
        lodash_1.default.forEach(toEmit, function (payload) {
