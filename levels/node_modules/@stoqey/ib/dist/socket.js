...
Socket.prototype._onConnect = function () {
    ...
    this._controller.run('sendAsync', [constants_1.default.CLIENT_VERSION]);
...
Socket.prototype.connect = function () {
    ...
    this._neverReceived = true;
    this._neverSent = true;
    this._client = net_1.default.connect({
...
Socket.prototype.send = function (tokens, async) {
    ...
    tokens = lodash_1.default.flatten([tokens]);
    lodash_1.default.forEach(tokens, function (value, i) {
